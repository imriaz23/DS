...
public class SubStringDistictChar {
     ...
     * characters.
     * 
     * Input: String="araaci", K=2 Output: 4 Explanation: The longest substring with no more than
     * '2' distinct characters is "araa".
     * 
     * 
     * Input: String="araaci", K=1 Output: 2 Explanation: The longest substring with no more than
